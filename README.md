# MeshCore MQTT Live Map v2.5.24
...
### v2.5.24 Feature Gallery

Version 2.5.24 keeps the Canada deployment intact while continuing the
...
docker run --rm -p 8080:8080 \
  ...
  ghcr.io/n30nex/mc-cartolive:2.5.24
```
...
The recommended v2.5.24 release path is clone + Docker Compose on a VPS or local
