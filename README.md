# MeshCore MQTT Live Map v2.5.19
...
### v2.5.19 Feature Gallery

Version 2.5.19 keeps the Canada deployment intact while continuing the
...
The recommended v2.5.19 release path is clone + Docker Compose on a VPS or local
