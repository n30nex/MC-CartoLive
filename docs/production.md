...
- Version 2.5.28 exposes the app version/build in the top project bar. CI builds use
...
- Version 2.5.28 also exposes public-safe public-cache truncation counts,
