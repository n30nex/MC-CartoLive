...
- Version 2.5.40 exposes the app version/build in the top project bar. CI builds use
...
- Version 2.5.40 also exposes public-safe public-cache truncation counts,
