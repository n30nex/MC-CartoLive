...
- Version 2.5.25 exposes the app version/build in the top project bar. CI builds use
...
- Version 2.5.25 also exposes public-safe public-cache truncation counts,
