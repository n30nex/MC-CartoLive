...
- Version 2.9.0 exposes app version, Git SHA, build number, and build time in
...
- OpenFreeMap/3D, terrain, propagation history, Packets, Chat, NetGraph, and
  VCR use sanitized public APIs and public WebSocket/history data.
