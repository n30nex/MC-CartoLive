...
- Version 2.5.22 exposes the app version/build in the top project bar. CI builds use
...
- Version 2.5.22 also exposes public-safe public-cache truncation counts,
