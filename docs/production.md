...
- Version 2.5.20 exposes the app version/build in the top project bar. CI builds use
...
- Version 2.5.20 also exposes public-safe public-cache truncation counts,
